...
import { idlFactory } from './token_ffftst.did.js';
export { idlFactory } from './token_ffftst.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_FFFTST_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_ffftst.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_ffftst canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_ffftst.did.js")._SERVICE>}
 */
export const token_ffftst = createActor(canisterId);
