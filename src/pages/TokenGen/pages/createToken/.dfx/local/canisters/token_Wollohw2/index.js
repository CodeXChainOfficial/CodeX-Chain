...
import { idlFactory } from './token_Wollohw2.did.js';
export { idlFactory } from './token_Wollohw2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_WOLLOHW2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_Wollohw2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_Wollohw2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_Wollohw2.did.js")._SERVICE>}
 */
export const token_Wollohw2 = createActor(canisterId);
