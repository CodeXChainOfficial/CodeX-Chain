...
import { idlFactory } from './token_wolloyy1.did.js';
export { idlFactory } from './token_wolloyy1.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_WOLLOYY1_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_wolloyy1.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_wolloyy1 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_wolloyy1.did.js")._SERVICE>}
 */
export const token_wolloyy1 = createActor(canisterId);
