...
import { idlFactory } from './token_testger.did.js';
export { idlFactory } from './token_testger.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_TESTGER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_testger.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_testger canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_testger.did.js")._SERVICE>}
 */
export const token_testger = createActor(canisterId);
