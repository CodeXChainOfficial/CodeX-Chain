...
import { idlFactory } from './token_Wolloh.did.js';
export { idlFactory } from './token_Wolloh.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_WOLLOH_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_Wolloh.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_Wolloh canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_Wolloh.did.js")._SERVICE>}
 */
export const token_Wolloh = createActor(canisterId);
