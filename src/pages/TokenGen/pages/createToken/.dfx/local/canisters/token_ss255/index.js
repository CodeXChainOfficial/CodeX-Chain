...
import { idlFactory } from './token_ss255.did.js';
export { idlFactory } from './token_ss255.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_SS255_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_ss255.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_ss255 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_ss255.did.js")._SERVICE>}
 */
export const token_ss255 = createActor(canisterId);
