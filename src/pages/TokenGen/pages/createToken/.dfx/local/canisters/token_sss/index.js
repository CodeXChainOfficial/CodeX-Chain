...
import { idlFactory } from './token_sss.did.js';
export { idlFactory } from './token_sss.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_SSS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_sss.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_sss canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_sss.did.js")._SERVICE>}
 */
export const token_sss = createActor(canisterId);
