...
import { idlFactory } from './token_sss2.did.js';
export { idlFactory } from './token_sss2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_SSS2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_sss2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_sss2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_sss2.did.js")._SERVICE>}
 */
export const token_sss2 = createActor(canisterId);
