...
import { idlFactory } from './token_luxy.did.js';
export { idlFactory } from './token_luxy.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_LUXY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_luxy.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_luxy canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_luxy.did.js")._SERVICE>}
 */
export const token_luxy = createActor(canisterId);
