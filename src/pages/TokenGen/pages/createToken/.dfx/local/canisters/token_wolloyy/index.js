...
import { idlFactory } from './token_wolloyy.did.js';
export { idlFactory } from './token_wolloyy.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_WOLLOYY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_wolloyy.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_wolloyy canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_wolloyy.did.js")._SERVICE>}
 */
export const token_wolloyy = createActor(canisterId);
