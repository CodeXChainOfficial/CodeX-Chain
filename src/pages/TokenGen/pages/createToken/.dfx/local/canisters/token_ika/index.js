...
import { idlFactory } from './token_ika.did.js';
export { idlFactory } from './token_ika.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_IKA_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_ika.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_ika canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_ika.did.js")._SERVICE>}
 */
export const token_ika = createActor(canisterId);
