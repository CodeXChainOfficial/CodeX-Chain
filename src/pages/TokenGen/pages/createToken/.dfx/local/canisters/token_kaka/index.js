...
import { idlFactory } from './token_kaka.did.js';
export { idlFactory } from './token_kaka.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_KAKA_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_kaka.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_kaka canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_kaka.did.js")._SERVICE>}
 */
export const token_kaka = createActor(canisterId);
