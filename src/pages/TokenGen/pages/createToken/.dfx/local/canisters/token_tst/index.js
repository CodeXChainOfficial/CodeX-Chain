...
import { idlFactory } from './token_tst.did.js';
export { idlFactory } from './token_tst.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_TST_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_tst.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_tst canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_tst.did.js")._SERVICE>}
 */
export const token_tst = createActor(canisterId);
