...
import { idlFactory } from './token_CDX.did.js';
export { idlFactory } from './token_CDX.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_CDX_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_CDX.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_CDX canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_CDX.did.js")._SERVICE>}
 */
export const token_CDX = createActor(canisterId);
