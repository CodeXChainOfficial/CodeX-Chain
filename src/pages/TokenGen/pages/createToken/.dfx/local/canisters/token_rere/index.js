...
import { idlFactory } from './token_rere.did.js';
export { idlFactory } from './token_rere.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_RERE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_rere.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_rere canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_rere.did.js")._SERVICE>}
 */
export const token_rere = createActor(canisterId);
