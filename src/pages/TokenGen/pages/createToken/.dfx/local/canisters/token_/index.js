...
import { idlFactory } from './token_.did.js';
export { idlFactory } from './token_.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN__CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_ canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_.did.js")._SERVICE>}
 */
export const token_ = createActor(canisterId);
