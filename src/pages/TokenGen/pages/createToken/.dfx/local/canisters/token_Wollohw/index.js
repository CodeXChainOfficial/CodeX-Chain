...
import { idlFactory } from './token_Wollohw.did.js';
export { idlFactory } from './token_Wollohw.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_WOLLOHW_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_Wollohw.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_Wollohw canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_Wollohw.did.js")._SERVICE>}
 */
export const token_Wollohw = createActor(canisterId);
