...
import { idlFactory } from './token_woll.did.js';
export { idlFactory } from './token_woll.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_WOLL_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_woll.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_woll canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_woll.did.js")._SERVICE>}
 */
export const token_woll = createActor(canisterId);
