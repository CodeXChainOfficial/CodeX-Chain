...
import { idlFactory } from './token_ss244.did.js';
export { idlFactory } from './token_ss244.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_SS244_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_ss244.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_ss244 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_ss244.did.js")._SERVICE>}
 */
export const token_ss244 = createActor(canisterId);
