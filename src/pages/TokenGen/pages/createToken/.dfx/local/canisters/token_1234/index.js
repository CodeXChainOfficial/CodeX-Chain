...
import { idlFactory } from './token_1234.did.js';
export { idlFactory } from './token_1234.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_1234_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_1234.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_1234 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_1234.did.js")._SERVICE>}
 */
export const token_1234 = createActor(canisterId);
