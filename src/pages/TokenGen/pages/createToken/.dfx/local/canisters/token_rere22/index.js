...
import { idlFactory } from './token_rere22.did.js';
export { idlFactory } from './token_rere22.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_RERE22_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_rere22.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_rere22 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_rere22.did.js")._SERVICE>}
 */
export const token_rere22 = createActor(canisterId);
