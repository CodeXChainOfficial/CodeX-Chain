...
import { idlFactory } from './token_gererg.did.js';
export { idlFactory } from './token_gererg.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_GERERG_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_gererg.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_gererg canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_gererg.did.js")._SERVICE>}
 */
export const token_gererg = createActor(canisterId);
