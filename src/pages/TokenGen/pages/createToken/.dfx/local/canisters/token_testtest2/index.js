...
import { idlFactory } from './token_testtest2.did.js';
export { idlFactory } from './token_testtest2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_TESTTEST2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_testtest2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_testtest2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_testtest2.did.js")._SERVICE>}
 */
export const token_testtest2 = createActor(canisterId);
