...
import { idlFactory } from './token_222.did.js';
export { idlFactory } from './token_222.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_222_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_222.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_222 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_222.did.js")._SERVICE>}
 */
export const token_222 = createActor(canisterId);
