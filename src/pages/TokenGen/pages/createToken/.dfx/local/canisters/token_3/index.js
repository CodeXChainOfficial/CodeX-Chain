...
import { idlFactory } from './token_3.did.js';
export { idlFactory } from './token_3.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_3_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_3.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_3 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_3.did.js")._SERVICE>}
 */
export const token_3 = createActor(canisterId);
