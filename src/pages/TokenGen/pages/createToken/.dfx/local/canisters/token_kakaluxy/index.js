...
import { idlFactory } from './token_kakaluxy.did.js';
export { idlFactory } from './token_kakaluxy.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_KAKALUXY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_kakaluxy.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_kakaluxy canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_kakaluxy.did.js")._SERVICE>}
 */
export const token_kakaluxy = createActor(canisterId);
