...
import { idlFactory } from './token_kaka22.did.js';
export { idlFactory } from './token_kaka22.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_KAKA22_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_kaka22.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_kaka22 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_kaka22.did.js")._SERVICE>}
 */
export const token_kaka22 = createActor(canisterId);
