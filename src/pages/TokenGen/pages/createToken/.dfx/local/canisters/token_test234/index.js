...
import { idlFactory } from './token_test234.did.js';
export { idlFactory } from './token_test234.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_TEST234_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_test234.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_test234 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_test234.did.js")._SERVICE>}
 */
export const token_test234 = createActor(canisterId);
